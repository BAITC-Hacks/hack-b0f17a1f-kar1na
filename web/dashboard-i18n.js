...
const rows = [
 ...
 ['Power Generation Forecast','Прогноз выработки энергии','Энергия өндіру болжамы'],['AI-powered hourly forecast','Почасовой прогноз на основе ИИ','ЖИ негізіндегі сағаттық болжам'],['Forecast','Прогноз','Болжам'],['Confidence interval','Доверительный интервал','Сенімділік аралығы'],['Forecast status','Статус прогноза','Болжам күйі'],['Weather & power forecast pipeline','Прогноз погоды и выработки энергии','Ауа райы мен энергия өндіру болжамы'],
 ...
 ['02 / ANALYTICS','02 / АНАЛИТИКА','02 / ТАЛДАУ'],['Energy in context.','Энергия в контексте.','Энергия туралы деректер.'],['Forecast, weather and historical turbine trends in one view.','Прогноз, погода и история турбин на одном экране.','Болжам, ауа райы және турбина тарихы бір экранда.'],['Power Forecast','Прогноз мощности','Қуат болжамы'],['03 / AI AGENT','03 / ИИ-АГЕНТ','03 / ЖИ-АГЕНТ'],['From signal to forecast.','От сигнала к прогнозу.','Сигналдан болжамға дейін.'],['Explore the actual backend execution path for the selected turbine.','Этапы расчёта прогноза для выбранной турбины.','Таңдалған турбина болжамын есептеу кезеңдері.'],['Agentic AI Pipeline','Процесс работы ИИ','ЖИ жұмыс үдерісі'],['Recalculate forecast ↗','Пересчитать прогноз ↗','Болжамды қайта есептеу ↗'],['Execution History','История выполнения','Орындалу тарихы'],['Latest backend run · timestamps in UTC+05','Последний запуск · время UTC+05','Соңғы іске қосу · уақыт UTC+05'],
 ['Mar 2023 — Jan 2026 · daily SCADA means (UTC), gaps preserved','Март 2023 — Январь 2026 · среднесуточные SCADA (UTC), пропуски сохранены','Наурыз 2023 — Қаңтар 2026 · күндік SCADA орташа мәндері (UTC), бос аралықтар сақталған'],
